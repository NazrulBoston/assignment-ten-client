            ...
            <form onSubmit={handleAddProduct}>
                ...
                <div className="md:flex mb-6">
                    <div className="form-control md:w-1/2">
                        ...
                        <label className="input-group">
                            <input type="text" name="name" placeholder="url of image" className="input input-bordered w-full" />
                        </label>
                    </div>
                ...
                <div className=" mb-6">
                    <div className="form-control w-full">
                        ...
                        <label className="input-group">
                            <input type="text" name="image" placeholder="photo" className="input input-bordered w-full" />
                        </label>
                    </div>
                </div>
